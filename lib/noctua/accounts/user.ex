defmodule Noctua.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Noctua.Repo)
  ...
  """
  def valid_password?(%Noctua.Accounts.User{hashed_password: hashed_password}, password)
